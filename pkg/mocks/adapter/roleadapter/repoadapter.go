...
// Source: github.com/alchasni/golang-projects-a/pkg/core/adapter/roleadapter (interfaces: RepoAdapter)

// Package mock_roleadapter is a generated GoMock package.
package mock_roleadapter

import (
	context "context"
	roleadapter "golang-projects-a/pkg/core/adapter/roleadapter"
...
func (m *MockRepoAdapter) Create(arg0 context.Context, arg1 roleadapter.RepoCreate) (domain.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepoAdapter) Find(arg0 context.Context, arg1 uint32) (domain.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepoAdapter) GetList(arg0 context.Context, arg1 roleadapter.RepoFilter) (domain.Roles, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetList", arg0, arg1)
	ret0, _ := ret[0].(domain.Roles)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepoAdapter) Update(arg0 context.Context, arg1 uint32, arg2 roleadapter.RepoUpdate) (domain.Role, error) {
	m.ctrl.T.Helper()
