...
// Source: golang-projects-a/pkg/core/adapter/commentadapter (interfaces: RepoAdapter)

// Package mock_commentadapter is a generated GoMock package.
package mock_commentadapter

import (
	context "context"
	gomock "github.com/golang/mock/gomock"
	commentadapter "golang-projects-a/pkg/core/adapter/commentadapter"
...
func (m *MockRepoAdapter) Create(arg0 context.Context, arg1 commentadapter.RepoCreate) (domain.Comment, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepoAdapter) DeleteMany(arg0 context.Context, arg1 commentadapter.RepoFilter) error {
	m.ctrl.T.Helper()
...
func (mr *MockRepoAdapterMockRecorder) DeleteMany(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteMany", reflect.TypeOf((*MockRepoAdapter)(nil).DeleteMany), arg0, arg1)
}

// Find mocks base method
func (m *MockRepoAdapter) Find(arg0 context.Context, arg1 uint64) (domain.Comment, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepoAdapter) GetList(arg0 context.Context, arg1 commentadapter.RepoFilter) (domain.Comments, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetList", arg0, arg1)
	ret0, _ := ret[0].(domain.Comments)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepoAdapter) Update(arg0 context.Context, arg1 uint64, arg2 commentadapter.RepoUpdate) (domain.Comment, error) {
	m.ctrl.T.Helper()
