...
func (s Service) Delete(ctx context.Context, req DeleteReq) (serviceErr service.Error) {
	...
	err = s.OrganizationRepo.Delete(ctx, req.id)
	if err != nil {
		switch {
		case errors.Is(err, adapter.ErrNotFound):
			return service.ErrDatasourceAccess("organization not found")
		default:
			return service.ErrDatasourceAccess("delete organization query error")
		}
	}
